...
class RunRobotTaskTest {
    ...
    public void executeMultipleFiles() {
        ...
        def  task = project.task("executeMultipleFiles", type: RunRobotTask) {
    ...
    public void singleVariableFile() {
        ...
        def  task = project.task("singleVariableFile", type: RunRobotTask) {
    ...
    public void multipleVariableFiles() {
        ...
        def  task = project.task("multipleVariableFiles", type: RunRobotTask) {
    ...
    public void testFailure() {
        ...
        def  task = project.task("testFailure", type: RunRobotTask) {
    ...
    public void ignoreFailure() {
        ...
        def  task = project.task("ignoreFailure", type: RunRobotTask) {
            outputdir = "build/results-failure"
            data_sources = "src/test/acceptancetest/fail/fail.robot"
            ignoreFailures = true
        }
    ...
    public void singleVariable() {
        ...
        def  task = project.task("singleVariable", type: RunRobotTask) {
    ...
    public void multipleVariables() {
        ...
        def  task = project.task("multipleVariables", type: RunRobotTask) {
    ...
    public void singleSuite() {
        ...
        def  task = project.task("singleSuite", type: RunRobotTask) {
    ...
    public void multipleSuites() {
        ...
        def  task = project.task("multipleSuites", type: RunRobotTask) {
    ...
    public void customSuiteName() {
        ...
        def  task = project.task("customSuiteName", type: RunRobotTask) {
    ...
    public void customSuiteDoc() {
        ...
        def  task = project.task("customSuiteDoc", type: RunRobotTask) {
    ...
    public void singleMetadata() {
        ...
        def  task = project.task("singleMetadata", type: RunRobotTask) {
    ...
    public void multipleMetadata() {
        ...
        def  task = project.task("multipleMetadata", type: RunRobotTask) {
    ...
    public void singleTag() {
        ...
        def  task = project.task("singleTag", type: RunRobotTask) {
    ...
    public void multipleTags() {
        ...
        def  task = project.task("multipleTags", type: RunRobotTask) {
    ...
    public void singleTest() {
        ...
        def  task = project.task("singleTest", type: RunRobotTask) {
            outputdir = "build/results-singleTest"
    ...
    public void multipleTests() {
        ...
        def  task = project.task("multipleTests", type: RunRobotTask) {
            outputdir = "build/results-multipleTests"
            data_sources = "src/test/acceptancetest/tests"
    ...
    public void rerunfailed() {
        ...
        def  task = project.task("rerunfail", type: RunRobotTask) {
        ...
        //rerunfailed
        def  taskrerun = project.task("rerunfailed", type: RunRobotTask) {
